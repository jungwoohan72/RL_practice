...
class Qnet(nn.Module):
    def __init__(self, observation_dim, action_dim, l1_channel = 256, l2_channel = 128):
        super(Qnet, self).__init__()
        self.fc_s = nn.Linear(observation_dim, l1_channel)
        self.fc_a = nn.Linear(l1_channel + action_dim, l2_channel)
...
class mu_net(nn.Module):
    def __init__(self, observation_dim, action_dim, l1_channel = 256, l2_channel = 128):
        ...
        self.fc_mu = nn.Linear(l2_channel, action_dim)
